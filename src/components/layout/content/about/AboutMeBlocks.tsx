		...
		<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10'>
			{blocks.map((block, index) => {
				...
				return (
					...
					>
						<div className='rounded-full bg-neutral-700/45 border border-neutral-700 p-4 w-18 h-18 flex items-center justify-center'>
							<Icon className='w-16 h-16 text-neutral-100/95' />
						</div>
