...
export function TechStackItem({ tech }: TechStackItemProps) {
	return (
		<Link
			...
			title={tech.name}
			className={twMerge('flex flex-col items-center justify-center group p-6 rounded-2xl  border border-neutral-700 bg-neutral-800/30 hover:bg-neutral-700/20 transform hover:scale-105 duration-300 shadow-lg',
